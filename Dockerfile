...
RUN curl -L http://bit.ly/google-chrome-stable -o chrome.deb && apt-get -y install ./chrome.deb && rm chrome.deb
...
RUN Rscript -e 'remotes::install_version("pagedown",upgrade="never", version = "0.17")'
