...
mod_survey_inputs_experience_ui <- function(id){
  ...
  tagList(
    ...
    dateInput(ns("date_start"), label = "date_start", value = Sys.Date()),
    dateInput(ns("date_end"), label = "date_end", value = Sys.Date()),
    textInput(ns("bullet1"), label = "Bullet Point 1", value = ""),
    textInput(ns("bullet2"), label = "Bullet Point 2", value = ""),
    textInput(ns("bullet3"), label = "Bullet Point 3", value = ""),
    textInput(ns("bullet4"), label = "Bullet Point 4", value = ""),
    textInput(ns("bullet5"), label = "Bullet Point 5", value = ""),
    textInput(ns("bullet6"), label = "Bullet Point 6", value = "")
  )
}
